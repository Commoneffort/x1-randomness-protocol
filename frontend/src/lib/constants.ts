...
// Fee distribution (V4.5)
export const FEE_VALIDATORS_PCT = 95;
export const FEE_INSURANCE_PCT  = 0;
...
export const EE_V4_N_CONTRIBUTORS = 7;
export const EE_V4_M_THRESHOLD = 5;
export const VALIDATOR_MAX_CONSECUTIVE_MISSES = 5;
