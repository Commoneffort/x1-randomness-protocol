      ...
      <div className="space-y-10">
        ...
        <Section id="lifecycle" title="Round Lifecycle">
          ...
          <div className="space-y-2 mt-2">
            {[
              ...
              { n: "5", color: "bg-orange-50 border-orange-200", label: "claim_validator_reward", desc: "Each validator calls this once per round to receive: original_fees × 95% ÷ reveal_count. Requires the ValidatorReveal PDA created at reveal time." },
        ...
        <Section id="fees" title="Fee Economics">
          ...
          <p className="mt-2">
            ...
            The crank caller receives 5% immediately; 95% stays in escrow for validators.
            Each validator who called <Code>reveal_via_ee</Code> in that round can then call <Code>claim_validator_reward</Code>{" "}
            to receive <Code>original_fees × 95% ÷ reveal_count</Code>.
          </p>
        </Section>
        ...
        <Section id="keeper" title="Running a Validator Node">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            {[
              ...
              { k: "Reward per round", v: "original_fees × 95% ÷ reveal_count" },
            ].map(({ k, v }) => (
